...
namespace _2026_1C_Estacionamiento.Controllers
{
    public class DireccionesController : Controller
    {
        ...
        {
            var estacionamientoContext = _context.Direccion.Include(d => d.Cliente);
        ...
        public async Task<IActionResult> Create([Bind("Id,Calle,Altura,CodigoPostal,Localidad,Provincia,ClienteId")] Direccion direccion)
        {
            ...
            ViewData["ClienteId"] = new SelectList(_context.Set<Cliente>(), "Id", "Apellido", direccion.ClienteId);
            return View(direccion);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Calle,Altura,CodigoPostal,Localidad,Provincia,ClienteId")] Direccion direccion)
        {
            if (id != direccion.Id)
            {
                return NotFound();
